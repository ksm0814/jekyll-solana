...
<br/>
<rb>1.</rb> <dfn> url에 정보를 전달하기 </dfn><br/>

<rb>2.</rb> <dfn>쿠키를 이용하기</dfn><br/>

<rb>3.</rb> <dfn>세션을 이용하기</dfn><br/>
<br/>
...
~~~
 ...
 <rb>2.</rb> <code>wget --no-check-certificate --no-cookies --header "Cookie: oraclelicense=accept-securebackup-cookie" jdk 다운로드 url</code><br/>

 <rb>3.</rb> ln -s jdk폴더이름 / Java
 <br/> Java로 닉네임을 짓는다.<br/>

 <rb>4.</rb> vi .bash_profile 편집기에 들어가 환경변수 설정을 확인

 <rb>5.</rb> ~/.bashrc을 입력해 재부팅 안하고도 바꾼 설정을 바로 적용할 수 있게 해준다.
